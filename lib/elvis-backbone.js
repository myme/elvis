...
(function() {
  ...
  ModelBinding = (function(_super) {
    ...
    ModelBinding.prototype.getValue = function() {
      ...
      return (_ref = this.context).get.apply(_ref, args);
    };

    ModelBinding.prototype.setValue = function() {
      var args, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.context).set.apply(_ref, args);
    };
  ...
  ViewBinding = (function(_super) {
    ...
    ViewBinding.prototype.getValue = function() {
      var args, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.context.model).get.apply(_ref, args);
    };

    ViewBinding.prototype.setValue = function() {
      var args, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.context.model).set.apply(_ref, args);
    };
